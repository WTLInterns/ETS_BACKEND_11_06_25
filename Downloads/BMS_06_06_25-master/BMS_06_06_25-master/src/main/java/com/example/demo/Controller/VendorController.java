...
public class VendorController {
    ...
    public ResponseEntity<?> onboardVendorOld(@RequestBody com.example.demo.Model.VendorForm vendorForm,
        ...
        try {
            ...
            vendor.setPassword(vendorForm.getPassword() != null ? vendorForm.getPassword() : vendorForm.getContactNo());
            vendor.setMasterAdmin(masterAdmin);
            Vendor saved = vendorService.createVendor(vendor,vendorImage,gstNoImage,govtApprovalCertificate,vendorDocs,aadharPhoto,panPhoto,vendorCompanyLogo);
    ...
    public ResponseEntity<?> updateVendor(
        ...
        try {
            Vendor updated = vendorService.updateVendor(id, vendor, vendorImage, gstNoImage, govtApprovalCertificate, vendorDocs, aadharPhoto, panPhoto,vendorCompanyLogo);
