...
public class WhatsAppService {
    ...
    public boolean sendTextMessage(String message, String recipientPhoneNumber) {
        try {
            ...
            System.out.println("API URL: '" + whatsAppConfig.getApiUrl() + "'");
            System.out.println("Phone Number ID: '" + whatsAppConfig.getPhoneNumberId() + "'");
            System.out.println("Access Token length: " + (whatsAppConfig.getAccessToken() != null ? whatsAppConfig.getAccessToken().length() : "null"));
            ...
            System.out.println("WhatsApp Response Status: " + response.getStatusCode());
